...
public class ScannerTest {
	...
	public void testLala() {
		this.dfa = DFA_LALA;
		yields("");
		yields("La     LaLa", "La     La", "La");
		yields("La     LaLaLi", "La     LaLaLi");
		yields("La La La La La La Li", "La La ", "La La ", "La La ");
		yields("La   Laaaa Laaa Li La La LaLi", "La   Laaaa Laaa Li ", "La La LaLi");
	}
